...
<body>
    <div class="action  divaction">
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
      	<s:iterator value="claimVoucher.bizCheckResults"  begin="0" status="s">
         <tr>
           <td width="27%"><s:property value="sysEmployee.name" />(<s:property value="sysEmployee.sysPosition.nameCn" />)</td>
           <td width="20%">&lt;<s:date name="checkTime" format="yyyy-MM-dd hh:mm:ss"/></td>
           <td width="38%">审核：<span class="red"><strong><s:property value="result" /></strong></span></td>
         </tr>
         <tr>
           <td>审核意见：<strong><s:property value="comm" /></td>
           <td>&nbsp;</td>
           <td>&nbsp;</td>
         </tr>
         <tr>
		...
		<tr>
		 ...
		 <tr>
			<td colspan="3" class="submit">
				...
				<input type='hidden' id="claimId" name="checkResult.bizClaimVoucher.id" value="<s:property value='claimVoucher.id'/>"/>
				<input type='hidden' id="result" name="checkResult.result" value=""/>
				<s:if test='#session.employee.sysPosition.nameCn != "财务"'>
